package com.gank.io.retrofitdemo.stickylistheaders;
...
public class StickyListHeadersListView extends FrameLayout {
    ...
    private void updateOrClearHeader(int firstVisiblePosition) {
        Log.e(Constant.TAG, "updateOrClearHeader: " + firstVisiblePosition);
    ...
    private void updateHeader(int headerPosition) {
        Log.e(Constant.TAG, "updateHeader: " + headerPosition);
        // check if there is a new header should be sticky
        Log.e(Constant.TAG, "mHeaderPosition: " + mHeaderPosition);
        Log.e(Constant.TAG, "headerPosition: " + headerPosition);
    ...
    private class WrapperListScrollListener implements OnScrollListener {
        ...
        public void onScroll(AbsListView view, int firstVisibleItem,
            ...
            Log.e(Constant.TAG, "WrapperListScrollListener:");
