package com.gank.io.retrofitdemo.stickylistheaders.activity;
...
import com.gank.io.retrofitdemo.stickylistheaders.StickyListHeadersListView;
...
//        stickyList.addFooterView(getLayoutInflater().inflate(R.layout.list_footer, null));
        ...
        mDrawerToggle = new ActionBarDrawerToggle(
                ...
                R.mipmap.ic_launcher_round,  /* nav drawer icon to replace 'Up' caret */
...
//        }
        Log.e(Constant.TAG, "onStickyHeaderOffsetChanged: "+header.toString() + "    " + offset);
    }

    @Override
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public void onStickyHeaderChanged(StickyListHeadersListView l, View header, int itemPosition, long headerId) {
        Log.e(Constant.TAG, "onStickyHeaderChanged: "+header.toString() + "   " + itemPosition);
        header.setAlpha(1);
    }
